...
const Header = () => {
  return (
    <div className='w-full flex justify-between justify-items-center py-6   round-3xl  '>
        <div className='w-1/2 px-20 flex justify-center flex-col gap-y-3 '>
            ...
            <button className='gb-prc nnf-bold  uppercase py-5  w-1/2 rounded-lg logo ease-linear duration-700'>
                Crear tu perfil
            </button>
        </div>
        <div className='w-1/2  flex justify-center p-4  py-8 rounded-3xl'>
            <img src={Logo} className='w-60 logo ease-in-out   duration-700' alt="" />
        </div>
    </div>
  )
}
