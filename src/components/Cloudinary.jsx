...
const Cloudinary = ({setImageProfile}) => {

    const preset_name = "MetProfileImg";                         //16 Pegamos el "name" rescatado en el punto 24
    const cloud_name = "dbdtsgzvk"                          //16.2 Pegamos el cloud_name rescatado en punto 20
  ...
  return (
    <div className='flex flex-col'>
        ...
        <img src={image} className='w-20' alt="imagen subida"/>
        )}
        {/* ------------------------------------------------------------------------------------ */}
