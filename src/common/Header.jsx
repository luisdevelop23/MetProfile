  ...
  return (
    <div className="mx-auto flex w-11/12 flex-col items-center justify-between rounded-3xl py-6 pt-20 lg:flex-row">
      <div className="flex w-full flex-col justify-center gap-y-3 px-4 md:px-20 lg:w-4/6">
        <h1 className="nnf-extra-bold prc text-center text-6xl duration-100 ease-in-out md:text-left">
          MET PROFILE
        </h1>
        ...
        <div className="flex justify-center md:justify-start">
          <Link to="/register">
            <button className="gb-prc nnf-bold nnf-bold logo hidden px-3 text-white rounded-lg py-3 text-2xl uppercase duration-700 ease-linear md:py-5 lg:block">
              Crear tu perfil
            </button>
          </Link>
        </div>
      ...
      <div className="flex w-full flex-col items-center justify-center rounded-3xl p-4 py-8 lg:w-2/6">
        ...
        />
        <Link to="/register">
          <button className="gb-prc nnf-bold logo mt-8 text-white rounded-lg py-3 uppercase duration-700 ease-linear md:mt-6 md:px-4  md:py-5 lg:hidden">
            Crear tu perfil
          </button>
        </Link>
      </div>
